...
TASK2AVG_SCORES = {
    ...
    'panx': {'avg_f1': 57.41666666666667, 'avg_precision': 56.66666666666667,
             'avg_recall': 58.75},
    'udpos': {'avg_f1': 72.42738730075851, 'avg_precision': 73.44851822488093,
              'avg_recall': 71.63920871597493},
